...
class ResponseServiceTest extends TestCase
{
    ...
    public function it_creates_a_forbidden_response()
    {
        ...
        $this->assertEquals('FORBIDDEN', \GuzzleHttp\json_decode($response->getContent())->errors[0]->detail);
    }
    ...
    public function it_creates_a_not_found_response()
    {
        ...
        $this->assertEquals('NOT FOUND', \GuzzleHttp\json_decode($response->getContent())->errors[0]->detail);
    }
    ...
    public function it_creates_a_unauthorized_response()
    {
        ...
        $this->assertEquals('UNAUTHORIZED', \GuzzleHttp\json_decode($response->getContent())->errors[0]->detail);
    }
}
